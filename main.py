...
def mage_hero():
    ...
    while choose:
        ...
        for i in bio:
            ...
            gameDisplay.blit(textSurf, textRect)
        start_button("Play", display_width/2, 450, 100, 50, black, dark_gray, mage, start_game)
        button("Back", 680, 20, 100, 50, black, dark_gray, choose_hero)
...
def hunter_hero():
    ...
    while choose:
        ...
        for i in bio:
            ...
            gameDisplay.blit(textSurf, textRect)
        start_button("Play", display_width/2, 450, 100, 50, black, dark_gray, hunter, start_game)
        button("Back", 680, 20, 100, 50, black, dark_gray, choose_hero)
        pygame.display.update()
...
def barb_hero():
    ...
    while choose:
        ...
        for i in bio:
            ...
            gameDisplay.blit(textSurf, textRect)
        start_button("Play", display_width/2, 450, 100, 50, black, dark_gray, barb, start_game)
        button("Back", 680, 20, 100, 50, black, dark_gray, choose_hero)
        pygame.display.update()
...
def choose_hero():
    ...
    while choose:
        ...
        gameDisplay.blit(TextSurf, TextRect)
        button("Barbarian", 350, 150, 100, 50, black, dark_gray, barb_hero)
        button("Hunter", 350, 250, 100, 50, black, dark_gray, hunter_hero)
        button("Mage", 350, 350, 100, 50, black, dark_gray, mage_hero)
        button("Back", 350, 450, 100, 50, black, dark_gray, game_intro)
        pygame.display.update()
...
def game_intro():
    ...
    while intor:
        ...
        gameDisplay.blit(TextSurf, TextRect)
        button("Play", 150, 450, 100, 50, black, dark_gray, choose_hero)
        button("Quit", 550, 450, 100, 50, black, dark_gray, quitgame)
        pygame.display.update()
